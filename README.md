...
<html>
    <head>
        ...
        <style>
            ...
            .A:active{transition-duration: 0.1s; border: 5px solid rgb(0, 0, 0);}
    ...
    <body>
        <div id="Problem">
            ...
            <div class="Line" id="L10">
                <div class="AKeypad R1 A" id="A1" onclick="Answer(1)">1</div>
                <div class="AKeypad R2 A" id="A2" onclick="Answer(2)">2</div>
                <div class="AKeypad R3 A" id="A3" onclick="Answer(3)">3</div>
                <div class="AKeypad R4 A" id="A4" onclick="Answer(4)">4</div>
                <div class="AKeypad R5 A" id="A5" onclick="Answer(5)">5</div>
            </div>
        </div>
        <div id="N"></div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $(".Keypad").dblclick(function() {
                    if (Give == false){document.getElementById($(this).attr("id")).textContent = '-'}
                });
            });
        </script>
    </body>
